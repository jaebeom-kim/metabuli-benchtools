...
// These are referenced only by the WeightedTaxHit constructor / weightedMajorityLCA,
// which are unused by the benchmark tools but kept for source fidelity. Defined
// here (not in a shared header) to avoid colliding with the CLI Parameters type.
namespace {
struct Parameters {
